...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image('bob-front', 'img2/Bob+front.png');
    this.load.image('bob-back', 'img2/Bob+back.png');
    this.load.image('bob-side', 'img2/Bob+side.png');
  ...
  create() {
    ...
    let scoreText = this.add.text(140, 610, `Król Swiata: $${score}`, { fontSize: '25px', fill: '#fff' });
    ...
    this.physics.add.overlap(gameState.player, gameState.money, () => {
      ...
      scoreText.setText(`Król Swiata: \$${score}`);
